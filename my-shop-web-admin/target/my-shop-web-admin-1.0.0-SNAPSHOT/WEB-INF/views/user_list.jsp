...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="/main"><i class="fa fa-users"></i> 首页</a></li>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <button type="button" class="btn btn-sm btn-primary"
                                    onclick="$('.box-info-search').toggle(500)">
                        ...
                        <div class="box-body table-responsive">
                            <table id="dataTable" class="table table-hover">
                                <thead>
                                <tr>
                                    <th><input type="checkbox" id="icheck_master" class="minimal icheck_master"/></th>
                                    <th>ID</th>
                                    <th>用户名</th>
                                    <th>手机号</th>
                                    <th>邮箱</th>
...
<script>
    ...
    $(function () {
        var _columns = [
            ...
            {
                "data": function (row, type, val, meta) {
                    return DateTime.format(row.updated, "yyyy年MM月dd日 HH:mm:ss");
                }
            },
            {
                "data": function (row, type, val, meta) {
