...
<div class="login-box-body">
    ...
    <form action="/login" method="post">
        ...
        <div class="form-group has-feedback">
            <input type="email" class="form-control" required="required" name="email" placeholder="邮箱" value="${email}">
        ...
        <div class="row">
            <div class="col-xs-8">
                <div class="checkbox icheck">
                    <br>
                    <label>
                        <input name="flagRemember" type="checkbox" ${isRemember == true ? "checked" : ""}> 记住我
                    </label>
                </div>
            </div>
            <br>
